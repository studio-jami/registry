...
The worker keeps Mintlify as the primary docs origin for general docs, while
serving the generated preview docs for `/docs/registry`, `/docs/workbench`, and `/docs/suites`
directly from `public/preview-docs/*.html`.
