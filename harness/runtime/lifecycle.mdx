...
description: "Runs, sessions, tasks, turns, and handoffs: how Jami Harness moves an agent run from start to evidence-bearing completion under a contract-first run lifecycle."
...
See [configuration reference](/harness/reference-configuration) for the full schema map.
