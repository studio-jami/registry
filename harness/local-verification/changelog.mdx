...
description: "How .changes/ fragments become Jami Harness release notes, the required fragment format, and the rules for what counts as a production-meaningful change."
