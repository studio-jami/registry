...
sidebarTitle: "MCP"
description: "Trusted in-process Model Context Protocol fixtures pinned to spec 2025-11-25, and the exact MCP transports and authorization surfaces Harness does not support."
